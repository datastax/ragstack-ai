...
We recommend LangChain's OpenAIEmbeddings class for embedding your split documents into vectors.
...
For more on the environment variables, see xref:ROOT:prerequisites.adoc[].
+
[source,python]
----
import os
