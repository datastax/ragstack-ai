...
Prompt design is an entire field of its own. See https://www.datastax.com/guides/what-is-prompt-engineering[What is Prompt Engineering in AI and How Does it Work?].
