...
This page demonstrates using RAGStack and an {db-vector} database to perform vector search with the *Maximal Marginal Relevance (MMR)* algorithm.
...
+
.. Copy your Astra DB Endpoint from the Astra DB database.
+
