...
image::https://colab.research.google.com/assets/colab-badge.svg[align="left",link="http://colab.research.google.com/github/CassioML/cassio-website/blob/main/docs/frameworks/langchain/.colab/colab_qa-maximal-marginal-relevance.ipynb"]

This page demonstrates using RAGStack and an Astra vector database to perform vector search with the *Maximal Marginal Relevance (MMR)* algorithm.
...
[source,text]
----
ASTRA_DB_ID=aad075g237-8ab4-4d81-aa7d-7f58dbed3ead
...
[NOTE]
====
The `ASTRA_DB_ID` can be found in the Astra DB endpoint. If your Astra DB endpoint is `https://aad075g237-8ab4-4d81-aa7d-7f58dbed3ead-us-east-2.apps.astra.datastax.com`, then your `ASTRA_DB_ID` is `aad075g237-8ab4-4d81-aa7d-7f58dbed3ead`.
====
+
