...
* Create an https://docs.datastax.com/en/astra-serverless/docs/getting-started/create-db-choices.html[{db-vector} database].
...
----
. Build a RAG pipeline using the populated Astra DB vector store.
+
[source,python]
----
prompt = """
