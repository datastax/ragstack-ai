# docker run -d -p 5010:5001 --rm -v $(pwd)/data:/data ghcr.io/nlmatics/nlm-ingestor:latest
...
def import_docs(llmSherpa_api_url, collection_name):
    ...
    for file_path in glob.glob('data/history_of_alexnet/source_files/*.pdf'):
        ...
        try:
            ...
            print(
                f"Exception loading file with LayoutPDFReader, using PyPDFLoader instead")
            vector_store.add_documents(
                splitter.split_documents(PyPDFLoader(file_path).load()))
