...
class ColbertVectorStore(BaseVectorStore):
    ...
    def _validate_embedding_model(self):
        if self._embedding_model is None:
            raise AttributeError("To use this method, `embedding_model` must be set on class creation.")
    ...
    def add_texts(self, texts: List[str], metadatas: Optional[List[Metadata]] = None, doc_id: Optional[str] = None) -> List[Tuple[str, int]]:
        """
    ...
    def as_retriever(self) -> BaseRetriever:
        ...
        self._validate_embedding_model()
        return ColbertRetriever(database=self._database, embedding_model=self._embedding_model)
