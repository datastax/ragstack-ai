...
class CassandraDatabase(BaseDatabase):
    ...
    def __new__(cls):
        if cls._instance is None:
            raise ValueError("This class cannot be instantiated directly. Please use the `from_astra()` or `from_session()` class methods.")
    ...
    def from_astra(
        ...
        if cls._instance is None:
            ...
            return cls.from_session(session=session, keyspace=keyspace, table_name=table_name)
        return cls._instance
    ...
    def from_session(
        ...
        if cls._instance is None:
            ...
            cls._instance._initialize(session=session, keyspace=keyspace, table_name=table_name)
        return cls._instance
    ...
    def _initialize(
        ...
        logging.info(f"Cassandra store is running on {'AstraDB' if is_astra else 'Apache Cassandra'}.")
