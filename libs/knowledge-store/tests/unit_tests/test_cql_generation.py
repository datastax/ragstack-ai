...
def test_cql_generation() -> None:
    ...
    gs._keyspace = "test_keyspace"
    gs._node_table = "test_table"
    gs._session = FakeSession()
    gs._prepared_query_cache = {}

    # replaces _query_by_embedding()
    query, values = gs._get_search_cql_and_params(limit=2, embedding=[0, 1])
    ...
    # replaces _query_ids_and_link_to_tags_by_embedding()
    query, values = gs._get_search_cql_and_params(
    ...
    # replaces _query_ids_and_embedding_by_embedding()
    query, values = gs._get_search_cql_and_params(
    ...
    # replaces _query_targets_by_kind_and_value()
    query, values = gs._get_search_cql_and_params(
    ...
    # replaces _query_targets_embeddings_by_kind_and_tag_and_embedding()
    columns = """
...
def test_cql_generation_with_metadata() -> None:
    ...
    gs._session = FakeSession()
    gs._prepared_query_cache = {}
    gs._metadata_indexing_policy = (MetadataIndexingMode.DEFAULT_TO_SEARCHABLE, set())
